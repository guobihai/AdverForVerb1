...
//            解析接收到的 json 信息
            if (udpReceiveCallback != null && receivePacket!=null && receivePacket.getAddress()!=null) {
                udpReceiveCallback.OnParserComplete(receivePacket.getAddress().getHostAddress());
            }
//            每次接收完UDP数据后，重置长度。否则可能会导致下次收到数据包被截断。
    ...
    public interface OnUDPReceiveCallbackBlock {
        void OnParserComplete(String data);
    }
